...
#setwd("~/Google Drive/Data cloning/Sea lice model/")
setwd("~/Data cloning")
...
# #------------------------------------------------------
# December 11, 2015: Try moving some of the points closer together to see if estimability gets worse
...
save.image("20160113_allPriors_removed.RData")	